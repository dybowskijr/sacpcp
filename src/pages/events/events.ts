...
export class EventPage {
    ...
    ngOnInit() {
        ...
        this.orgServices.getMyOrganizations().subscribe({
            next: (data) => {
                this.myGroupAdminOrganizations = data.filter(org => org.role == 1);
            }
        }
        );
    }
    ...
    amISignedUp(id): boolean {
        ...
        return this.volunteerEventsService.myEvents.find(myEvent => myEvent.event_id == id) !== undefined;
    }
